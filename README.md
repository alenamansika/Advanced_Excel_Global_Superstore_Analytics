# 📊 Global Superstore Advanced Analytics (Advanced Excel Interactive Dashboard)

## 📌 Project Overview
Proyek ini menganalisis data transaksi global **Global Superstore Orders (51.290 transaksi)** menggunakan teknik **Advanced Excel Charting & Interactive Dashboard Architecture** untuk menghasilkan analisis visual yang dinamis, otomatis, dan berstandar industri. 
...
* **Key Insight:** Penjualan global tumbuh pesat dari **$2.259K (2011)** ke **$2.677K (2012)** (**+18,5%**), terkoreksi pada **2013** menjadi **$2.384K** (**-11,0%**) akibat krisis *Global Supply Chain Bottleneck*, sebelum akhirnya melonjak tajam pada **2014** mencapai **$4.299K** (**+80,4%**).

![Chart 1 - YoY Sales Trend with Percentage Growth & Error Bars](chart1_yoy_trend.png)
...
![Chart 2 - Interactive Histogram with Regional Breakdown & Slicer](chart2_histogram.png)
...
![Chart 3 - Annual Trend with Monthly Detail & Slicer Year](chart3_seasonality.png)
...
![Chart 4 - Frequency Distribution Chart with Scroll Bar](chart4_frequency_scrollbar.png)
